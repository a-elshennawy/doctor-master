    ...
    <div className="container">
      ...
      <div id="footerRow" className="row">
        ...
        <div className="col-md-3 col-sm-6 ">
          ...
          <ul>
            <li id="footerKnow">
              <a href="#"></a>Dental Care
            </li>
            <li id="footerKnow">
              <a href="#"></a>Cardiac Clinic
            </li>
            <li id="footerKnow">
              <a href="#"></a>Massege Therapy
            </li>
            <li id="footerKnow">
              <a href="#"></a>Cardiology
            </li>
            <li id="footerKnow">
              <a href="#"></a>Precise Diagnosis
            </li>
            <li id="footerKnow">
              <a href="#"></a>Abmbulance Services
            </li>
          </ul>
        </div>
        ...
        <div className="col-md-3 col-sm-6 ">
          ...
          {/* this was <from><from/> instead of <form><form/> */}
          <form id="form-input">
            <input id="input-one" type="text" />
            <button id="input-tow" type="submit" className="btn btn-primary">
              Submit
            </button>
          </form>
          <ul id="icon-FOOTER">
